...
const DashboardSideBar = ({ active }) => {
  return (
    <div
      className="w-full h-[90vh[ bg-white shadow-sm overflow-y-scroll sticky top-0 left-0
         z-10"
    >
      {/**single items */}
      <div className="w-full flex items-center p-4 ">
        <Link
          to="/dashboard"
          className="w-full flex items-center hover:text-[#3321c8]"
        >
          <RxDashboard
            size={30}
      ...
      <div className="w-full flex items-center p-4">
        <Link to="/dashboard-products" className="w-full flex items-center">
          <FiPackage size={30} color={`${active === 3 ? "#3321c8" : "#555"}`} />
          <h5
            className={`hidden 800px:block pl-2 text-[18px] font-[400] ${
