const styles = {
  ...
  productDiscountPrice: "font-bold text-[20px] text-[#333] font-Roboto",
  price: "font-[500] text-[16px] text-[#d55b45] pl-3 mt-[-4px] line-through",
  shop_name: "pt-3 text-[15px] text-[#3321c8] pb-3",
  ...
  cart_button:
    "px-[20px] h-[38px] rounded-[20px] bg-[#3321c8] flex items-center justify-center cursor-pointer",
